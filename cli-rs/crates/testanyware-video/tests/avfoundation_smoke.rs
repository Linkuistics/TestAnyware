//! macOS encoder smoke test: synthetic RGBA frames must produce a readable
//! MP4. This is the self-contained verification ADR-0006 / leaf 100 call for
//! — it exercises the full AVFoundation graph (writer → input → pixel-buffer
//! adaptor → finish) without a live VM, and runs on this macOS host.
#![cfg(target_os = "macos")]
